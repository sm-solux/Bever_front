...
class HollysReviewList extends Component {
  state = {
    drinkID: '음료아이디',
    writer: '글 작성자 아이디',
    title: '게시글 제목',
  ...
  renderReviewItem = () => (
    <TouchableOpacity
      onPress={()=>this.props.navigation.navigate('HollysReviewView')}>
      <View style={styles.reviewItemView}>
        <Image
          source={require('../../../assets/images/hollys.jpg')}
    ...
    return (
      ...
      {/* 게시글 작성 버튼 */}
        <TouchableOpacity
          ...
          onPress={() => {this.props.navigation.navigate('HollysReviewPost')}}
        >
          <Image 
...
export default HollysReviewList;